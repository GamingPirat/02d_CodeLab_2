...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.print(mitarbeiter1.getInfo("familyname"));
        System.out.print(mitarbeiter1.getInfo("firstname"));
        System.out.print(mitarbeiter1.getInfo("role"));
        System.out.println(mitarbeiter1.getInfo("yearofentry"));
        ...
        System.out.print(mitarbeiter2.getInfo("familyname"));
        System.out.print(mitarbeiter2.getInfo("firstname"));
        System.out.print(mitarbeiter2.getInfo("role"));
        System.out.println(mitarbeiter2.getInfo("yearofentry"));
        ...
        System.out.print(mitarbeiter3.getInfo("familyname"));
        System.out.print(mitarbeiter3.getInfo("firstname"));
        System.out.print(mitarbeiter3.getInfo("role"));
        System.out.println(mitarbeiter3.getInfo("yearofentry"));
